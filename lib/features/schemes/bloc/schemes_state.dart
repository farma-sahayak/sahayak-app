...
class SchemesState extends Equatable {
  ...
  // Helper getters
  List<Scheme> get eligibleSchemes => schemes.where((s) => s.status == SchemeStatus.eligible).toList();
  List<Scheme> get appliedSchemes => schemes.where((s) => s.status == SchemeStatus.applied).toList();
  List<Scheme> get notEligibleSchemes => schemes.where((s) => s.status == SchemeStatus.notEligible).toList();
  List<Scheme> get approvedSchemes => schemes.where((s) => s.status == SchemeStatus.approved).toList();
  List<Scheme> get rejectedSchemes => schemes.where((s) => s.status == SchemeStatus.rejected).toList();
