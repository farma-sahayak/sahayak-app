    ...
    return AppCard(
      ...
      child: Column(
        ...
        children: [
          ...
          if (scheme.status == SchemeStatus.applied && scheme.progressPercentage != null) ...[
            _ProgressIndicator(
          ...
          if (scheme.tags.isNotEmpty) ...[
            Wrap(
              ...
              runSpacing: 4,
              children: scheme.tags.take(3).map((tag) => _TagChip(tag: tag)).toList(),
            ),
            const SizedBox(height: AppConstants.mediumPadding),
          ],
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _getPrimaryActionButton(context),
              ),
              const SizedBox(width: AppConstants.smallPadding),
              ...
              IconButton(
                onPressed: scheme.brochureUrl != null ? onDownloadBrochure : null,
                icon: Icon(
                  Icons.download,
