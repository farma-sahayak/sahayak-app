...
class BenefitsOverviewCard extends StatelessWidget {
  ...
  const BenefitsOverviewCard({super.key, required this.benefitsOverview});
            ...
            children: [
              Expanded(
                child: _StatColumn(
                  ...
                  value:
                      '${benefitsOverview.currency}${numberFormat.format(benefitsOverview.totalPotentialBenefit)}',
                  subtitle: 'per year',
