...
class LoadSchemes extends SchemesEvent {
  ...
  const LoadSchemes({this.farmerId, this.state, this.crop, this.category});
...
class RefreshSchemes extends SchemesEvent {
  ...
  const RefreshSchemes({this.farmerId, this.state, this.crop, this.category});
...
class ApplyForScheme extends SchemesEvent {
  ...
  const ApplyForScheme({required this.farmerId, required this.schemeId});
...
class FilterSchemes extends SchemesEvent {
  ...
  const FilterSchemes({this.status, this.category, this.searchQuery});
...
class DownloadBrochure extends SchemesEvent {
  ...
  const DownloadBrochure({required this.brochureUrl, required this.schemeName});
