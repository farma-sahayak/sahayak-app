...
class CropDetailedCard extends StatelessWidget {
  ...
  const CropDetailedCard({super.key, required this.crop});
  ...
  Widget _buildProfitSection() {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.currency_rupee, color: Color(0xFF388E3C), size: 16),
  ...
  Widget _buildNextActionSection() {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.schedule, color: Color(0xFF1976D2), size: 16),
          const SizedBox(width: 8),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
    ...
    try {
      ...
      if (image != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Image uploaded successfully! AI analysis coming soon.',
            ),
