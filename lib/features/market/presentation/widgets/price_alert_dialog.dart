...
class PriceAlertDialog extends StatefulWidget {
  ...
  const PriceAlertDialog({super.key, required this.price});
    ...
    return AlertDialog(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                items: const [
                  DropdownMenuItem(
                    value: '>=',
                    child: Text('Greater than or equal to (≥)'),
                  ),
                  DropdownMenuItem(
                    value: '<=',
                    child: Text('Less than or equal to (≤)'),
                  ),
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: const Text('Set Alert', style: TextStyle(color: Colors.white)),
        ),
      ],
    );
  }
